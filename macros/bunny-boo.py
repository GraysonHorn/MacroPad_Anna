...
app = {                    # REQUIRED dict, must be named 'app'
    ...
    'macros' : [           # List of button macros...
        ...
        # 1st row ----------
        (0x200010, 'FknWKND', [Keycode.COMMAND, Keycode.OPTION, 'W']),
        (0x200020, 'MUSIC', [Keycode.F4, -Keycode.F4, 'Chrome\n', 0.5,
                              'https://www.youtube.com/watch?v=DXMDWfLclNY\n']),
        (0x400010, 'DANCE', [Keycode.F4, -Keycode.F4, 'Chrome\n', 0.5,
                             'https://dribbble.com/shots/10754795-dancing-couple\n']),      # Scroll up
        # 2nd row ----------
        (0x004020, 'Tab', [Keycode.CONTROL, Keycode.SHIFT, Keycode.TAB]),
        (0x204020, 'HamMsg', 'Arrooo this is hammy! You are da best momma ever!! I cant'
                               'wait to jump on you and snooze and smoochy, and get treats!'
                                'aruff ruff bark'),
        (0x204000, 'LoveMsg', 'I am the luckiest guy alive to have an amazing woman as you in'
